...
public class SecurityConfig {
	@Bean
	public JdbcUserDetailsManager users() {  ///Jdbc el objeto de base de datos
		DriverManagerDataSource ds=new DriverManagerDataSource();// un obejto de dataSource
	...
	public SecurityFilterChain filter(HttpSecurity http) throws Exception {
		http.csrf(c -> c.disable())
				.authorizeHttpRequests(aut -> aut.requestMatchers(HttpMethod.GET, "/buscarvuelos/*").authenticated()
						...
						.requestMatchers(HttpMethod.PUT, "/actualizarvuelo").hasAnyRole("OPERATORS").anyRequest()
						.permitAll())
