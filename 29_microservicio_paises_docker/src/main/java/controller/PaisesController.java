...
public class PaisesController {
	...
	public ResponseEntity<List<Pais>> paisesPorContinentes(@PathVariable("continente") String continente){
		try {
			List<Pais> paises=paisesService.paisesePorContinente(continente);
